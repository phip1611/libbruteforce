...
//!
//! ```
//! use libbruteforce::{CrackParameter, symbols, transform_fns};
...
//! let sha256_hash = transform_fns::str_to_sha256_hash("3d7edde33628331676b39e19a3f2bdb3c583960ad8d865351a32e2ace7d8e02d");
//! // sha256("a+c")
//! let res = libbruteforce::crack(
//!     CrackParameter::new(
//!         sha256_hash, alphabet, 3, 0, transform_fns::SHA256_HASHING, true,
//!     )
//! );
//! if res.is_success() {
